		...
		switch (msg.$) {
			...
			case 'Tick':
				...
				var _v1 = function () {
					...
					if (_v2.$ === 'Battle') {
						var enemy = _v2.a;
						var updateClock = function (card) {
							return (_Utils_cmp(card.clock, card.energy) < 0) ? _Utils_update(
								card,
								{clock: card.clock + 1}) : _Utils_update(
								card,
								{clock: 0});
						};
						var tickedTeam = A2(
							$elm$core$List$map,
							function (c) {
								return A2($elm$core$Maybe$map, updateClock, c);
							},
							model.team);
						var addDamage = F2(
							function (card, accumulatedDamage) {
								return (!card.clock) ? (accumulatedDamage + card.attack) : accumulatedDamage;
							});
						var newEnemy = _Utils_update(
							enemy,
							{
								health: enemy.health - A3(
									$elm$core$List$foldl,
									addDamage,
									0,
									$elm_community$maybe_extra$Maybe$Extra$values(tickedTeam))
							});
						return _Utils_Tuple2(
							$author$project$Main$Battle(newEnemy),
							tickedTeam);
					} else {
						return _Utils_Tuple2(model.phase, model.team);
					}
				}();
				var newPhase = _v1.a;
				var newTeam = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{phase: newPhase, team: newTeam, time: newTime}),
			...
			case 'StartGame':
				...
				if ((_v3.a.$ === 'Introduction') && (_v3.b.$ === 'Just')) {
					var _v4 = _v3.a;
					var randoms = _v3.b.a;
			...
			default:
				var msg_ = msg.a;
				var _v5 = _Utils_Tuple2(model.phase, model.randoms);
				if ((_v5.a.$ === 'Build') && (_v5.b.$ === 'Just')) {
					var queue = _v5.a.a;
					var randoms = _v5.b.a;
					var _v6 = A2($norpan$elm_html5_drag_drop$Html5$DragDrop$update, msg_, model.cardDragDrop.dragDrop);
					var newDragDrop = _v6.a;
					var result = _v6.b;
					...
					var _v7 = function () {
						var _v8 = _Utils_Tuple2(result, model.phase);
						if ((_v8.a.$ === 'Just') && (_v8.b.$ === 'Build')) {
							var _v9 = _v8.a.a;
							var card = _v9.a;
							var slot = _v9.b;
							var q = _v8.b.a;
