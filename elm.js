...
var $author$project$Main$Model = F5(
	function (time, randoms, team, phase, cardDragDrop) {
		return {cardDragDrop: cardDragDrop, phase: phase, randoms: randoms, team: team, time: time};
	});
...
var $elm_community$json_extra$Json$Decode$Extra$datetime = A2(
	...
	$elm$json$Json$Decode$string);
var $author$project$Main$Battle = function (a) {
	return {$: 'Battle', a: a};
};
var $author$project$Main$Build = function (a) {
	return {$: 'Build', a: a};
};
...
var $author$project$Cards$getCard = function (id) {
	var _v0 = A2($elm_community$list_extra$List$Extra$getAt, id, $author$project$Cards$deck);
	if (_v0.$ === 'Just') {
		var card = _v0.a;
		return card;
	} else {
...
var $author$project$Enemies$ogre = {attack: 4, energy: 2, health: 300, name: 'Ogre'};
var $author$project$Enemies$titan = {attack: 3, energy: 3, health: 500, name: 'Titan'};
var $author$project$Enemies$deck = _List_fromArray(
	[$author$project$Enemies$ogre, $author$project$Enemies$hydra, $author$project$Enemies$titan]);
var $author$project$Enemies$getEnemy = function (id) {
	var _v0 = A2($elm_community$list_extra$List$Extra$getAt, id, $author$project$Enemies$deck);
	if (_v0.$ === 'Just') {
		var card = _v0.a;
		return card;
	} else {
		return $author$project$Enemies$ogre;
	}
};
		...
		switch (phase) {
			...
			case 'build':
				return A2(
					...
					A2(
						$elm$json$Json$Decode$map,
						$elm$core$List$map($author$project$Cards$getCard),
						A2(
							$elm$json$Json$Decode$field,
							'queue',
			...
			case 'battle':
				return A2(
					...
					A2(
						$elm$json$Json$Decode$map,
						$author$project$Enemies$getEnemy,
						A2($elm$json$Json$Decode$field, 'enemy', $elm$json$Json$Decode$int)));
			default:
				return $elm$json$Json$Decode$fail(phase + ' is not a recognised Phase');
		}
	};
	return A2(
		$elm$json$Json$Decode$andThen,
		decodePhaseAssociations,
		A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string));
}();
var $author$project$Main$Randoms = F2(
	function (queue, enemy) {
		return {enemy: enemy, queue: queue};
	});
var $author$project$Main$decodeRandoms = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Randoms,
	A2(
		$elm$json$Json$Decode$field,
		'queue',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$int)),
...
var $author$project$Main$decode = A6(
	...
	A2(
		$elm$json$Json$Decode$field,
		'randoms',
		$elm$json$Json$Decode$nullable($author$project$Main$decodeRandoms)),
	A2($elm$json$Json$Decode$field, 'team', $author$project$Main$decodeTeam),
	A2($elm$json$Json$Decode$field, 'phase', $author$project$Main$decodePhase),
	$elm$json$Json$Decode$succeed($author$project$Main$emptyCardDragDrop));
...
var $author$project$Main$emptyModel = {
	cardDragDrop: $author$project$Main$emptyCardDragDrop,
	phase: $author$project$Main$Introduction,
	randoms: $elm$core$Maybe$Nothing,
	team: A2($elm$core$List$repeat, 4, $elm$core$Maybe$Nothing),
	time: $elm$time$Time$millisToPosix(0)
};
var $author$project$Main$UpdateRandoms = function (a) {
	return {$: 'UpdateRandoms', a: a};
};
...
var $author$project$Main$generateRandoms = function () {
	var createRandoms = F2(
		function (queue, enemy) {
			return {enemy: enemy, queue: queue};
		});
	return A2(
		$elm$random$Random$generate,
		$author$project$Main$UpdateRandoms,
		A3(
...
var $author$project$Main$init = function (flags) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decode, flags);
	if (_v0.$ === 'Ok') {
		var model = _v0.a;
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	} else {
		return _Utils_Tuple2($author$project$Main$emptyModel, $author$project$Main$generateRandoms);
	}
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'attack',
				$elm$json$Json$Encode$int(card.attack)),
				_Utils_Tuple2(
				'energy',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(enemy.name)),
				_Utils_Tuple2(
				'attack',
				$elm$json$Json$Encode$int(enemy.attack)),
				_Utils_Tuple2(
				'energy',
				$elm$json$Json$Encode$int(enemy.energy)),
				_Utils_Tuple2(
				'health',
				$elm$json$Json$Encode$int(enemy.health))
			]));
};
var $author$project$Main$encodePhase = function (phase) {
	switch (phase.$) {
		case 'Introduction':
			return $elm$json$Json$Encode$object(
				_List_fromArray(
...
var $author$project$Main$encodeRandoms = function (randoms) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'queue',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$int, randoms.queue)),
				_Utils_Tuple2(
				'enemy',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'randoms',
				A2($elm_community$json_extra$Json$Encode$Extra$maybe, $author$project$Main$encodeRandoms, model.randoms)),
				_Utils_Tuple2(
				'team',
				A2(
					$elm$json$Json$Encode$list,
				...
				_Utils_Tuple2(
				'phase',
				$author$project$Main$encodePhase(model.phase))
			]));
};
...
var $author$project$Main$removeLineFromQueue = function (queue) {
	return A2($elm$core$List$drop, 4, queue);
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UpdateRandoms':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							randoms: $elm$core$Maybe$Just(randoms)
						}),
					$elm$core$Platform$Cmd$none);
			case 'StartGame':
				var _v1 = _Utils_Tuple2(model.phase, model.randoms);
				if ((_v1.a.$ === 'Introduction') && (_v1.b.$ === 'Just')) {
					var _v2 = _v1.a;
					var randoms = _v1.b.a;
					var queue = A2($elm$core$List$map, $author$project$Cards$getCard, randoms.queue);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								phase: $author$project$Main$Build(queue)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			default:
				var msg_ = msg.a;
				var _v3 = _Utils_Tuple2(model.phase, model.randoms);
				if ((_v3.a.$ === 'Build') && (_v3.b.$ === 'Just')) {
					var queue = _v3.a.a;
					var randoms = _v3.b.a;
					var _v4 = A2($norpan$elm_html5_drag_drop$Html5$DragDrop$update, msg_, model.cardDragDrop.dragDrop);
					var newDragDrop = _v4.a;
					var result = _v4.b;
					var newCardDragDrop = function () {
						var _v8 = _Utils_Tuple2(
							$norpan$elm_html5_drag_drop$Html5$DragDrop$getDragId(newDragDrop),
							$norpan$elm_html5_drag_drop$Html5$DragDrop$getDropId(newDragDrop));
						if (_v8.a.$ === 'Just') {
							var dropId = _v8.b;
							if (result.$ === 'Just') {
								return {dragDrop: newDragDrop, highlightedSlot: $elm$core$Maybe$Nothing};
							} else {
								return {dragDrop: newDragDrop, highlightedSlot: dropId};
							}
						} else {
							return model.cardDragDrop;
						}
					}();
					var _v5 = function () {
						var _v6 = _Utils_Tuple2(result, model.phase);
						if ((_v6.a.$ === 'Just') && (_v6.b.$ === 'Build')) {
							var _v7 = _v6.a.a;
							var card = _v7.a;
							var slot = _v7.b;
							var q = _v6.b.a;
							return _Utils_Tuple2(
								$author$project$Main$removeLineFromQueue(q),
								A3(
							...
							return _Utils_Tuple2(queue, model.team);
						}
					}();
					var newQueue = _v5.a;
					var newTeam = _v5.b;
					var newPhase = (!$elm$core$List$length(newQueue)) ? $author$project$Main$Battle(
						$author$project$Enemies$getEnemy(randoms.enemy)) : $author$project$Main$Build(newQueue);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{cardDragDrop: newCardDragDrop, phase: newPhase, team: newTeam}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$Main$viewEnemy = function (enemy) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('portrait')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(enemy.name)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('health')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(enemy.health))
							]))
					]))
			]));
};
var $author$project$Main$ResetModel = {$: 'ResetModel'};
var $author$project$Main$phaseToString = function (stage) {
	switch (stage.$) {
		case 'Introduction':
			return 'Introduction';
		case 'Build':
...
var $author$project$Main$viewHeader = function (phase) {
	var phaseTitle = function () {
		if (phase.$ === 'Introduction') {
			return '';
		} else {
			return $author$project$Main$phaseToString(phase) + ' Phase';
		}
	}();
	return A2(
		$elm$html$Html$div,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(phaseTitle)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$ResetModel)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewHero = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('hero-points')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('hero-portrait')
				]),
			_List_Nil),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('hero-health')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text(
...
var $author$project$Main$viewIntroduction = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('stage')
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Welcome to Cards')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
...
var $author$project$Main$viewCard = F2(
	function (active, card) {
		var draggable = active ? A2($norpan$elm_html5_drag_drop$Html5$DragDrop$draggable, $author$project$Main$DragDropMsg, card) : _List_Nil;
		var clock = (card.clock / card.energy) * 100;
		return A2(
			$elm$html$Html$div,
			A2(
				$elm$core$List$cons,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('attack')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(card.attack))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('energy')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(card.energy))
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'height',
							$elm$core$String$fromFloat(clock) + '%')
						]),
					_List_Nil)
				]));
	});
var $author$project$Main$viewGroup = F2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2('active', !index)
						])),
					A2(
					$elm$html$Html$Attributes$style,
					'bottom',
					$elm$core$String$fromInt(index * 100) + 'px')
				]),
			A2(
				$elm$core$List$map,
				$author$project$Main$viewCard(!index),
				group));
	});
var $author$project$Main$viewQueue = function (queue) {
	var groups = A2($elm_community$list_extra$List$Extra$groupsOf, 4, queue);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2(
			...
			A2($elm$core$List$take, 4, groups)));
};
...
var $author$project$Main$viewSlot = F3(
	function (highlightedSlot, slot, card) {
		var cardDiv = function () {
			if (card.$ === 'Just') {
				var c = card.a;
				return _List_fromArray(
					[
						A2($author$project$Main$viewCard, false, c)
					]);
			} else {
				return _List_Nil;
			}
				...
				$elm$html$Html$Attributes$classList(
					_List_fromArray(
						[
							...
							_Utils_Tuple2(
							'active',
							$elm_community$maybe_extra$Maybe$Extra$isJust(card)),
							_Utils_Tuple2('slot', true)
						])),
				A2($norpan$elm_html5_drag_drop$Html5$DragDrop$droppable, $author$project$Main$DragDropMsg, slot)),
			cardDiv);
	});
var $author$project$Main$viewTeam = F2(
	function (team, highlightedSlot) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$indexedMap,
				$author$project$Main$viewSlot(highlightedSlot),
				team));
	});
var $author$project$Main$view = function (model) {
	var viewStage = function () {
		var _v0 = model.phase;
		switch (_v0.$) {
			case 'Introduction':
				return $author$project$Main$viewIntroduction;
			case 'Build':
				var queue = _v0.a;
				return A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewQueue, queue);
			default:
				var enemy = _v0.a;
				return A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewEnemy, enemy);
		}
	}();
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('cards-wrapper')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Lazy$lazy, $author$project$Main$viewHeader, model.phase),
						viewStage,
						$author$project$Main$viewHero,
						A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewTeam, model.team, model.cardDragDrop.highlightedSlot)
					]))
			]));
};
...
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Cards.Card":{"args":[],"type":"{ name : String.String, attack : Basics.Int, energy : Basics.Int, clock : Basics.Int }"},"Main.Randoms":{"args":[],"type":"{ queue : List.List Basics.Int, enemy : Basics.Int }"},"Html5.DragDrop.Position":{"args":[],"type":"{ width : Basics.Int, height : Basics.Int, x : Basics.Int, y : Basics.Int }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"Tick":["Time.Posix"],"ResetModel":[],"UpdateRandoms":["Main.Randoms"],"StartGame":[],"DragDropMsg":["Html5.DragDrop.Msg Cards.Card Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Html5.DragDrop.Msg":{"args":["dragId","dropId"],"tags":{"DragStart":["dragId","Json.Decode.Value"],"DragEnd":[],"DragEnter":["dropId"],"DragLeave":["dropId"],"DragOver":["dropId","Basics.Int","Html5.DragDrop.Position"],"Drop":["dropId","Html5.DragDrop.Position"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});}(this));